...
class ProfileMain extends Component {
  ...
  handleFormSubmit = (event) => {
    ...
    axios.post(`http://localhost:8080/jobonja_war_exploded/main/AddSkillController?nameOfwantedSkill=${event.target.value}&token=${"Bearer " + localStorage.getItem('token')}`
  //   ,{
