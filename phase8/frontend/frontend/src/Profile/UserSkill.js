...
class UserSkill extends Component {
    ...
    EndorseCtrl =text=>()=>{
        axios.put(`http://localhost:8080/jobonja_war_exploded/main/EndorseController?id=${this.props.user.id}&skillName=${text}&token=${"Bearer " + localStorage.getItem('token')}`
      //   ,{
