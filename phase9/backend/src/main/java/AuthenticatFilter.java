...
//            }
            ...
            try {
                ...
                if ( jwt != null ) {
                    ...
                    int loggedInUserID = getAuthentication(httpRequest ,jwt);
                    System.out.println("iddddddddddd "+loggedInUserID);
                    servletRequest.setAttribute("loggedInUser",loggedInUserID);
